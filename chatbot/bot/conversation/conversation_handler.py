...
async def refine_question(
    llm: Any, question: str, chat_history: ChatHistory, max_new_tokens: int = 128
) -> str:
    """
...
async def answer(llm: Any, question: str, chat_history: ChatHistory, max_new_tokens: int = 512) -> Any:
    """
